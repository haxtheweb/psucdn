define(["./app-datepicker-icons.js", "./animations/datepicker-slide-from-left-animation.js", "./animations/datepicker-slide-from-right-animation.js", "../@polymer/iron-selector/iron-selector.js", "../@polymer/iron-list/iron-list.js", "../@polymer/paper-icon-button/paper-icon-button.js", "../@polymer/neon-animation/neon-animated-pages.js", "../@polymer/neon-animation/neon-animation-runner-behavior.js", "../@polymer/neon-animation/animations/fade-in-animation.js", "../@polymer/neon-animation/animations/fade-out-animation.js", "../@polymer/neon-animation/animations/slide-from-left-animation.js", "../@polymer/neon-animation/animations/slide-from-right-animation.js", "../@polymer/neon-animation/neon-animatable.js", "../@polymer/polymer/lib/legacy/polymer.dom.js", "../@polymer/polymer/lib/legacy/class.js", "../@polymer/polymer/polymer-element.js"], function (_appDatepickerIcons, _datepickerSlideFromLeftAnimation, _datepickerSlideFromRightAnimation, _ironSelector, _ironList, _paperIconButton, _neonAnimatedPages, _neonAnimationRunnerBehavior, _fadeInAnimation, _fadeOutAnimation, _slideFromLeftAnimation, _slideFromRightAnimation, _neonAnimatable, _polymerDom, _class, _polymerElement) {
  ...
  function _templateObject_f8c5cce0598011eabae509a8b8475ead() {
    ...
    _templateObject_f8c5cce0598011eabae509a8b8475ead = function _templateObject_f8c5cce0598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_mixinBehaviors) {
    babelHelpers.inherits(AppDatepicker, _mixinBehaviors);

    function AppDatepicker() {
      babelHelpers.classCallCheck(this, AppDatepicker);
      return babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(AppDatepicker).apply(this, arguments));
    }

    babelHelpers.createClass(AppDatepicker, [{
      key: "connectedCallback",
      value: function connectedCallback() {
        babelHelpers.get(babelHelpers.getPrototypeOf(AppDatepicker.prototype), "connectedCallback", this).call(this);

        if (!this.noAnimation) {
          this.set("animationConfig", {
            "incrementEntry": [{
              name: "slide-from-right-animation",
              node: this.$.daysOfWeekAnimation
            }, {
              name: "slide-from-right-animation",
              node: this.$.daysOfMonthAnimation
            }, {
        ...
        this.dispatchEvent(new CustomEvent("app-datepicker-connected", {
          bubbles: true,
          composed: true
        }));
      ...
      key: "_computeDaysOfMonth",
      value: function _computeDaysOfMonth(_activeYear, _activeMonth, _firstDayOfWeek, _locale) {
      ...
      key: "_computeShiftedDisableDays",
      value: function _computeShiftedDisableDays(_firstDayOfWeek, _isDisableDays) {
      ...
      key: "_incrementMonth",
      value: function _incrementMonth(ev) {
      ...
      key: "_decrementMonth",
      value: function _decrementMonth(ev) {
      ...
      key: "_computeActiveMonthYear",
      value: function _computeActiveMonthYear(_activeYear, _activeMonth, _locale) {
        if (window.Intl) {
          _locale = _locale || window.Intl && window.Intl.DateTimeFormat && window.Intl.DateTimeFormat().resolvedOptions && window.Intl.DateTimeFormat().resolvedOptions().locale || "en-US";
      ...
      key: "_computeShortSelectedDate",
      value: function _computeShortSelectedDate(_selectedYear, _selectedMonth, _selectedDate, _locale) {
        if (window.Intl) {
          _locale = _locale || window.Intl && window.Intl.DateTimeFormat && window.Intl.DateTimeFormat().resolvedOptions && window.Intl.DateTimeFormat().resolvedOptions().locale || "en-US";
      ...
      key: "_computeShowSelectedYear",
      value: function _computeShowSelectedYear(_selectedYear, _locale) {
        if (window.Intl) {
          _locale = _locale || window.Intl && window.Intl.DateTimeFormat && window.Intl.DateTimeFormat().resolvedOptions && window.Intl.DateTimeFormat().resolvedOptions().locale || "en-US";
      ...
      key: "_chooseDaysOfMonth",
      value: function _chooseDaysOfMonth(ev) {
      ...
      key: "_isToday",
      value: function _isToday(_item, _activeYear, _activeMonth) {
        var _now = new Date();
      ...
      key: "_isEmptyDate",
      value: function _isEmptyDate(_item) {
        return this._isNumber(_item) ? "" : " is-non-selectable";
      } // Re-compute class if the item (day of month) is the selected date.

    }, {
      key: "_isChosenDaysOfMonth",
      value: function _isChosenDaysOfMonth(_item, _selectedYear, _selectedMonth, _selectedDate) {
      ...
      key: "_isDisableDays",
      value: function _isDisableDays(_index, _firstDayOfWeek, _minDate, _maxDate, _item) {
      ...
      key: "_isListOfYearsSelected",
      value: function _isListOfYearsSelected(selectedYear, year) {
        return +selectedYear === +year ? " is-selected" : "";
      }
    }, {
      key: "_computeDaysOfWeek",
      value: function _computeDaysOfWeek(_firstDayOfWeek, _locale) {
      ...
      key: "_computeChosenDaysOfMonth",
      value: function _computeChosenDaysOfMonth(_daysOfMonth, _selectedDate) {
      ...
      key: "_convertDateStringToDateObject",
      value: function _convertDateStringToDateObject(_date) {
      ...
      key: "_updateList",
      value: function _updateList(_activeView) {
      ...
      value: function _onAnimationFinish(ev) {
      ...
      key: "_updateListScroller",
      value: function _updateListScroller(_list) {
      ...
      key: "_onIronSelectorSelectedChanged",
      value: function _onIronSelectorSelectedChanged(ev) {
      ...
      key: "_onListRendered",
      value: function _onListRendered(ev) {
        // When noAnimation is truthy, this will update the list scroller.
      ...
      key: "_computeSeparateFormat",
      value: function _computeSeparateFormat(_format) {
      ...
      key: "_bindSelectedFulldate",
      value: function _bindSelectedFulldate(_selectedYear, _selectedMonth, _selectedDate, _format) {
      ...
      key: "_updateBindDate",
      value: function _updateBindDate(ev) {
      ...
      key: "_computeShowLongDate",
      value: function _computeShowLongDate(_showLongDate, _locale, _returnResult) {
      ...
      key: "_updateToReflectExternalChange",
      value: function _updateToReflectExternalChange(_inputDate) {
      ...
      key: "enforceDateChange",
      value: function enforceDateChange() {
        this._setInvalidDate(!1);
      ...
      key: "_shouldTabIndex",
      value: function _shouldTabIndex(_index, _firstDayOfWeek, _minDate, _maxDate, _item) {
      ...
      key: "_shouldAriaDisabled",
      value: function _shouldAriaDisabled(_index, _firstDayOfWeek, _minDate, _maxDate, _item) {
        var _isDisableDays = this._isDisableDays(_index, _firstDayOfWeek, _minDate, _maxDate, _item);
      ...
      key: "_padStart",
      value: function _padStart(_string, _length, _chars) {
        var _len = -_length;
      ...
      key: "_isNumber",
      value: function _isNumber(_value) {
      ...
      key: "_updateThemeColor",
      value: function _updateThemeColor(_theme) {
      ...
      key: "_updateDatepickerView",
      value: function _updateDatepickerView(_view) {
      ...
      key: "_updateDistributedButtonInkColorCustomProp",
      value: function _updateDistributedButtonInkColorCustomProp(_node, _colorCode) {
        _node.updateStyles({
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_f8c5cce0598011eabae509a8b8475ead());
      }
    }, {
      key: "properties",
      get: function get() {
