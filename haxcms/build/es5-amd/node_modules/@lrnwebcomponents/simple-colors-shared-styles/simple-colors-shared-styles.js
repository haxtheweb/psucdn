define(["exports", "../../lit-element/lit-element.js"], function (_exports, _litElement) {
  ...
  function _templateObject2_05ed6a40598111eabae509a8b8475ead() {
    ...
    _templateObject2_05ed6a40598111eabae509a8b8475ead = function _templateObject2_05ed6a40598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_05ed6a40598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject_05ed6a40598111eabae509a8b8475ead = function _templateObject_05ed6a40598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    babelHelpers.inherits(SimpleColorsSharedStyles, _LitElement);
    babelHelpers.createClass(SimpleColorsSharedStyles, [{
      key: "render",
      // render function
      value: function render() {
        return (0, _litElement.html)(_templateObject_05ed6a40598111eabae509a8b8475ead());
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_05ed6a40598111eabae509a8b8475ead())];
      }
    }, {
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(SimpleColorsSharedStyles), "properties", this), {
          /**
           * The colors object.
    ...
    function SimpleColorsSharedStyles() {
      ...
      babelHelpers.classCallCheck(this, SimpleColorsSharedStyles);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SimpleColorsSharedStyles).call(this));
      _this.colors = {
    ...
    babelHelpers.createClass(SimpleColorsSharedStyles, [{
      ...
      value: function getContrastingColors(colorName, colorShade, isLarge) {
        ...
        Object.keys(this.colors).forEach(function (color) {
          result[color] = _this2.getContrastingShades(isLarge, colorName, colorShade, color);
        });
        return result.color;
      }
      /**
  ...
  window.SimpleColorsSharedStyles.requestAvailability = function () {
    if (window.SimpleColorsSharedStyles.instance == null) {
      ...
      window.SimpleColorsSharedStyles.stylesheet.innerHTML = "".concat(SimpleColorsSharedStyles.styles[0].cssText);
