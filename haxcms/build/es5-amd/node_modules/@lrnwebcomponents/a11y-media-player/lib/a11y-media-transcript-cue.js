define(["exports", "../../../lit-element/lit-element.js", "../../simple-search/lib/simple-search-content.js"], function (_exports, _litElement, _simpleSearchContent) {
  ...
  function _templateObject2_07854850598111eabae509a8b8475ead() {
    ...
    _templateObject2_07854850598111eabae509a8b8475ead = function _templateObject2_07854850598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_07854850598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <span id=\"time\">\n        ", " - ", "\n      </span>\n      <span id=\"text\">\n        <slot></slot>\n      </span>\n    "]);

    _templateObject_07854850598111eabae509a8b8475ead = function _templateObject_07854850598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    babelHelpers.inherits(A11yMediaTranscriptCue, _LitElement);
    babelHelpers.createClass(A11yMediaTranscriptCue, null, [{
      key: "properties",
      // properties available to the custom element for data binding
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(A11yMediaTranscriptCue), "properties", this), {
          /**
    ...
    function A11yMediaTranscriptCue() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(A11yMediaTranscriptCue).call(this));
      _this.active = false;
    ...
    babelHelpers.createClass(A11yMediaTranscriptCue, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_07854850598111eabae509a8b8475ead(), this.start, this.end);
      }
    }, {
      key: "updated",
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName === "active" && _this2.active) _this2.dispatchEvent(new CustomEvent("active-changed", {
            detail: {
              element: _this2,
              oldValue: oldValue,
              value: _this2.active
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_07854850598111eabae509a8b8475ead())];
      }
    }]);
