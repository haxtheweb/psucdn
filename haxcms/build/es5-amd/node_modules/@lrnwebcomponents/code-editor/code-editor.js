define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../schema-behaviors/schema-behaviors.js"], function (_exports, meta, _require, _litElement, _schemaBehaviors) {
  ...
  function _templateObject2_f3f35d40598011eabae509a8b8475ead() {
    ...
    _templateObject2_f3f35d40598011eabae509a8b8475ead = function _templateObject2_f3f35d40598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_f3f35d40598011eabae509a8b8475ead() {
    ...
    _templateObject_f3f35d40598011eabae509a8b8475ead = function _templateObject_f3f35d40598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_SchemaBehaviors) {
    ...
    babelHelpers.createClass(CodeEditor, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_f3f35d40598011eabae509a8b8475ead())];
      }
      /**
       * HTMLElement
       */
    ...
    function CodeEditor() {
      ...
      _this.focused = false;
      _this.__libPath = decodeURIComponent(meta.url) + "/../../../monaco-editor/min/vs";
    ...
    babelHelpers.createClass(CodeEditor, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_f3f35d40598011eabae509a8b8475ead(), !this.title, this.title, this.autofocus, this.hideLineNumbers, this.__libPath, this.language, this.theme, this._editorDataChanged, this.fontSize, this.readOnly, this._handleFocus, this._handleBlur, !this.showCodePen, this.codePenData);
      }
    }, {
      key: "updated",
      ...
      value: function preProcessHaxNodeToContent(clone) {
