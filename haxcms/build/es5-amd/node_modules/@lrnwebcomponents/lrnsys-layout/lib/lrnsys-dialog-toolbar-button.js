define(["exports", "require", "../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject2_0b098d10598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: inline-block;\n        }\n        iron-icon {\n          display: inline-block;\n          height: 16px;\n          width: 16px;\n        }\n      "]);

    _templateObject2_0b098d10598111eabae509a8b8475ead = function _templateObject2_0b098d10598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_0b098d10598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-button\n        raised\n        @click=\"", "\"\n        id=\"", "\"\n        aria-label=\"", "\"\n      >\n        <iron-icon icon=\"", "\"></iron-icon> ", "\n      </paper-button>\n      <simple-tooltip for=\"", "\" animation-delay=\"0\"\n        >", "</simple-tooltip\n      >\n    "]);

    _templateObject_0b098d10598111eabae509a8b8475ead = function _templateObject_0b098d10598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(LrnsysDialogToolbarButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_0b098d10598111eabae509a8b8475ead(), this._onTap, this.id, this.title, this.icon, this.title, this.id, this.title);
      }
    }], [{
      key: "styles",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_0b098d10598111eabae509a8b8475ead())];
      }
    }, {
      key: "tag",
      get: function get() {
