define(["exports", "require", "../../lit-element/lit-element.js", "../responsive-utility/responsive-utility.js"], function (_exports, _require, _litElement, _responsiveUtility) {
  ...
  function _templateObject2_f2595c50598011eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div class=\"button-holding-pen\" ?hidden=\"", "\">\n        <paper-icon-button\n          class=\"direction\"\n          icon=\"hax:arrow-all\"\n          title=\"Drag\"\n          draggable=\"true\"\n          id=\"drag\"\n          @dragstart=\"", "\"\n          @dragend=\"", "\"\n        >\n        </paper-icon-button>\n        <paper-icon-button\n          class=\"direction\"\n          icon=\"hardware:keyboard-arrow-up\"\n          title=\"Move up\"\n          id=\"up\"\n          @click=\"", "\"\n        >\n        </paper-icon-button>\n        <paper-icon-button\n          class=\"direction\"\n          icon=\"hardware:keyboard-arrow-right\"\n          title=\"Move right\"\n          id=\"right\"\n          @click=\"", "\"\n        >\n        </paper-icon-button>\n        <paper-icon-button\n          class=\"direction\"\n          icon=\"hardware:keyboard-arrow-down\"\n          title=\"Move down\"\n          id=\"down\"\n          @click=\"", "\"\n        >\n        </paper-icon-button>\n        <paper-icon-button\n          class=\"direction\"\n          icon=\"hardware:keyboard-arrow-left\"\n          title=\"Move left\"\n          id=\"left\"\n          @click=\"", "\"\n        >\n        </paper-icon-button>\n      </div>\n      <div class=\"row\">\n        <div\n          class=\"column\"\n          id=\"col1\"\n          data-label=\"column 1\"\n          .style=\"", "\"\n        >\n          <slot name=\"col-1\"></slot>\n        </div>\n        <div\n          class=\"column\"\n          id=\"col2\"\n          data-label=\"column 2\"\n          .style=\"", "\"\n        >\n          <slot name=\"col-2\"></slot>\n        </div>\n        <div\n          class=\"column\"\n          id=\"col3\"\n          data-label=\"column 3\"\n          .style=\"", "\"\n        >\n          <slot name=\"col-3\"></slot>\n        </div>\n        <div\n          class=\"column\"\n          id=\"col4\"\n          data-label=\"column 4\"\n          .style=\"", "\"\n        >\n          <slot name=\"col-4\"></slot>\n        </div>\n        <div\n          class=\"column\"\n          id=\"col5\"\n          data-label=\"column 5\"\n          .style=\"", "\"\n        >\n          <slot name=\"col-5\"></slot>\n        </div>\n        <div\n          class=\"column\"\n          id=\"col6\"\n          data-label=\"column 6\"\n          .style=\"", "\"\n        >\n          <slot name=\"col-6\"></slot>\n        </div>\n      </div>\n    "]);

    _templateObject2_f2595c50598011eabae509a8b8475ead = function _templateObject2_f2595c50598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_f2595c50598011eabae509a8b8475ead() {
    ...
    _templateObject_f2595c50598011eabae509a8b8475ead = function _templateObject_f2595c50598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(GridPlate, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_f2595c50598011eabae509a8b8475ead())];
      }
    }]);
    ...
    babelHelpers.createClass(GridPlate, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_f2595c50598011eabae509a8b8475ead(), this.hideOps, this.dragStart, this.dragEnd, this.moveActiveElement, this.moveActiveElement, this.moveActiveElement, this.moveActiveElement, this._getColumnWidth(0, this.columnWidths), this._getColumnWidth(1, this.columnWidths), this._getColumnWidth(2, this.columnWidths), this._getColumnWidth(3, this.columnWidths), this._getColumnWidth(4, this.columnWidths), this._getColumnWidth(5, this.columnWidths));
      }
    }, {
      ...
      get: function get() {
        return {
          ...
          saveOptions: {
            unsetAttributes: ["grid-plate-active-item", "edit-mode", "active-item", "layouts", "columns", "options", "droppable", "ignorehax", "hideops", "disableresponsive", "activeitem"]
          }
        };
      }
    }, {
