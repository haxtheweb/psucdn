define(["exports", "require", "../../lit-element/lit-element.js", "../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _customStyle) {
  ...
  function _templateObject2_05657590598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          --scroll-button-z-index: 99;\n          z-index: var(--scroll-button-z-index);\n        }\n\n        :host([hidden]) {\n          display: none;\n        }\n        paper-icon-button {\n          background-color: rgba(0, 0, 0, 0.6);\n          color: white;\n        }\n        paper-icon-button:hover,\n        paper-icon-button:active,\n        paper-icon-button:focus {\n          background-color: rgba(0, 0, 0, 1);\n        }\n        simple-tooltip {\n          --simple-tooltip-background: #000000;\n          --simple-tooltip-opacity: 1;\n          --simple-tooltip-text-color: #ffffff;\n          --simple-tooltip-delay-in: 0;\n          --simple-tooltip-border-radius: 0;\n        }\n      "]);

    _templateObject2_05657590598111eabae509a8b8475ead = function _templateObject2_05657590598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_05657590598111eabae509a8b8475ead() {
    ...
    _templateObject_05657590598111eabae509a8b8475ead = function _templateObject_05657590598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ScrollButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_05657590598111eabae509a8b8475ead(), this.scrollEvent, this.icon, this.label, this.position, this.label);
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_05657590598111eabae509a8b8475ead())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
      ...
      key: "properties",
      get: function get() {
        return _objectSpread({}, babelHelpers.get(babelHelpers.getPrototypeOf(ScrollButton), "properties", this), {
          target: {
            type: Object
          },
          icon: {
    ...
    function ScrollButton() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(ScrollButton).call(this));
      _this.icon = "icons:expand-less";
      _this.label = "Scroll to top";
      _this.position = "top";
