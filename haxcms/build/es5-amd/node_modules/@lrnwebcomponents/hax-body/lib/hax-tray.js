define(["exports", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../a11y-collapse/lib/a11y-collapse-group.js", "../../a11y-collapse/a11y-collapse.js"], function (_exports, _require, _litElement, _utils, _a11yCollapseGroup, _a11yCollapse) {
  ...
  function _templateObject4_09cfad80598111eabae509a8b8475ead() {
    ...
    _templateObject4_09cfad80598111eabae509a8b8475ead = function _templateObject4_09cfad80598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject3_09cfad80598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <hax-tray-button\n                    mini\n                    @click=\"", "\"\n                    icon=\"save\"\n                    id=\"haxsavebutton\"\n                    label=\"", "\"\n                    color=\"green\"\n                    event-name=\"save\"\n                    voice-command=\"save content\"\n                    color-meaning\n                  ></hax-tray-button>\n                  <hax-tray-button\n                    mini\n                    icon=\"cancel\"\n                    id=\"haxcancelbutton\"\n                    label=\"Cancel\"\n                    event-name=\"cancel\"\n                    color=\"red\"\n                    voice-command=\"cancel\"\n                    color-meaning\n                  ></hax-tray-button>\n                  <hax-tray-button\n                    mini\n                    id=\"toggle-tray-size\"\n                    event-name=\"toggle-tray-size\"\n                    icon=\"", "\"\n                    label=\"", "\"\n                  ></hax-tray-button>\n                "]);

    _templateObject3_09cfad80598111eabae509a8b8475ead = function _templateObject3_09cfad80598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject2_09cfad80598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <hax-tray-button\n              .data-opened=\"", "\"\n              @click=\"", "\"\n              icon=\"create\"\n              id=\"button\"\n              color=\"black\"\n              label=\"", "\"\n            ></hax-tray-button>\n          "]);

    _templateObject2_09cfad80598111eabae509a8b8475ead = function _templateObject2_09cfad80598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxTray, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_09cfad80598111eabae509a8b8475ead(), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject2_09cfad80598111eabae509a8b8475ead(), this.editMode, this._clickEditButton, this.__tipText), this.hidePanelOps ? "" : (0, _litElement.html)(_templateObject3_09cfad80598111eabae509a8b8475ead(), this._clickSaveButton, this.__tipText, this.traySizeIcon, this.traySizeText), this.hideExportButton, !this.canUndo, !this.canRedo, this.hidePreferencesButton, this._gizmoBrowserRefresh, this.activeTagIcon, this.activeTagName, this.__simpleFieldsClick, this.__valueChangedEvent, this._appBrowserRefresh, this._refreshLists);
      }
    }, {
      ...
      value: function firstUpdated(changedProperties) {
        ...
        if (!this.__setup) {
          this.__setup = true; // fire an event that this is a core piece of the system
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "activeNode") {
            if (_this3.activeNode && _this3.activeNode.tagName) {
              if (!_this3.shadowRoot.querySelector("#settingscollapse").expanded) {
            ...
            _this3.activeHaxElement = window.HaxStore.nodeToHaxElement(_this3.activeNode, null);
      ...
      value: function _setupForm() {
        ...
        if (activeNode.tagName && window.HaxStore.instance.elementList[activeNode.tagName.toLowerCase()]) {
          ...
          this.shadowRoot.querySelector("#settingsform").value = _objectSpread({}, this.activeValue); // allow form to rebuild, then switch it to the correct input
            ...
            setTimeout(function () {
              ...
              try {
                ...
                disable.forEach(function (id) {
                  _this4.shadowRoot.querySelector("#settingsform").shadowRoot.querySelector("eco-json-schema-tabs").shadowRoot.querySelector("#" + id).disabled = true;
                }); // check for active tab being disabled

                if (_this4.shadowRoot.querySelector("#settingsform").shadowRoot.querySelector("eco-json-schema-tabs").shadowRoot.querySelector("#" + _this4.activeTab).disabled) {
                  // support active tab being disabled and having to move down
                  // to a new active tab
                  switch (_this4.activeTab) {
                    case "item-0":
                      _this4.activeTab = "item-1";

                      if (_this4.shadowRoot.querySelector("#settingsform").shadowRoot.querySelector("eco-json-schema-tabs").shadowRoot.querySelector("#" + _this4.activeTab).disabled) {
                        _this4.activeTab = "item-2";
                      }
                ...
                _this4.shadowRoot.querySelector("#settingsform").shadowRoot.querySelector("eco-json-schema-tabs").shadowRoot.querySelector("a11y-tabs").activeTab = _this4.activeTab;
              } catch (e) {}
            }, 10);
          }
        }
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_09cfad80598111eabae509a8b8475ead())];
      }
    }, {
      key: "properties",
      get: function get() {
