define(["exports", "meta", "require", "../../../lit-element/lit-element.js", "../../utils/utils.js", "../../hax-body-behaviors/hax-body-behaviors.js", "../../../undoer/undoer.js"], function (_exports, meta, _require, _litElement, _utils, _haxBodyBehaviors, _undoer) {
  ...
  function _templateObject2_096ad130598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: none;\n        }\n      "]);

    _templateObject2_096ad130598111eabae509a8b8475ead = function _templateObject2_096ad130598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_096ad130598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <slot></slot>\n      <undoer-element></undoer-element>\n      <iron-ajax\n        id=\"appstore\"\n        url=\"", "\"\n        .params=\"", "\"\n        method=\"GET\"\n        content-type=\"application/json\"\n        handle-as=\"json\"\n        @last-response-changed=\"", "\"\n      ></iron-ajax>\n      <hal-9000\n        id=\"hal\"\n        .responds-to=\"", "\"\n        .debug=\"", "\"\n      ></hal-9000>\n    "]);

    _templateObject_096ad130598111eabae509a8b8475ead = function _templateObject_096ad130598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_096ad130598111eabae509a8b8475ead(), this.appStore.url, this.appStore.params, this.__appStoreDataChanged, this.voiceRespondsTo, this.voiceDebug);
      }
    }, {
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "activeNode") {
            _this3.activeGizmo = _this3._calculateActiveGizmo(_this3[propName]);
            window.HaxStore.write("activeGizmo", _this3.activeGizmo, _this3);
          ...
          if (["haxAutoloader", "activeHaxBody", "haxToast", "haxExport", "haxPreferences", "haxAppPicker", "haxTray"].includes(propName)) {
            ...
            _this3._storePiecesAllHere(_this3.haxAutoloader, _this3.activeHaxBody, _this3.haxToast, _this3.haxExport, _this3.haxPreferences, _this3.haxAppPicker, _this3.haxTray);
          }
        });
      ...
      value: function firstUpdated(changedProperties) {
        ...
        new Promise(function (res, rej) {
          ...
          if (_this4.shadowRoot.querySelector("#appstore")) {
            _this4.shadowRoot.querySelector("#appstore").generateRequest();
          }
        ...
        new Promise(function (res, rej) {
          ...
          _this4.__hal = _this4.shadowRoot.querySelector("#hal");
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_096ad130598111eabae509a8b8475ead())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(HaxStore, [{
      ...
      value: function _haxStoreInsertContent(e) {
        ...
        if (e.detail) {
          ...
          setTimeout(function () {
            var gizmoList = _this6.gizmoList;
            ...
            for (var gizmoposition in gizmoList) {
              ...
              if (gizmo.tag === details.tag) {
                ...
                _this6.gizmoList.unshift(tmp);
              }
            } // spread for accurate data usage locally, then write store globally


            _this6.gizmoList = babelHelpers.toConsumableArray(gizmoList);
            window.HaxStore.write("gizmoList", gizmoList, _this6);
          }, 10);
        }
      }
      /**
