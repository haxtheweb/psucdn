define(["exports", "require", "../../../lit-element/lit-element.js", "../../simple-colors/simple-colors.js", "../../utils/utils.js"], function (_exports, _require, _litElement, _simpleColors, _utils) {
  ...
  function _templateObject2_0919cb00598111eabae509a8b8475ead() {
    ...
    _templateObject2_0919cb00598111eabae509a8b8475ead = function _templateObject2_0919cb00598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_0919cb00598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n        }\n        iron-icon:not(:defined),\n        paper-button:not(:defined),\n        paper-dialog:not(:defined) {\n          display: none;\n        }\n        #dialog {\n          z-index: 100000;\n          margin-top: 56px;\n        }\n        #closedialog {\n          top: 6px;\n          right: 0;\n          position: absolute;\n          padding: 8px;\n          margin: 0;\n          background-color: var(--hax-color-menu-heading-bg, #eeeeee);\n          color: var(--hax-color-menu-heading-color, black);\n          width: 40px;\n          height: 40px;\n          min-width: unset;\n        }\n        .title {\n          position: relative;\n          padding: 16px;\n          outline: 0;\n          font-weight: 600;\n          text-align: left;\n          margin: 0;\n          background-color: var(--hax-color-menu-heading-bg, #eeeeee);\n          color: var(--hax-color-menu-heading-color, black);\n          font-size: 18px;\n          line-height: 18px;\n          font-family: \"Noto Serif\", serif;\n        }\n        .pref-container {\n          text-align: left;\n          padding: 16px;\n        }\n        #reportghissue {\n          color: #81a3a9;\n          font-size: 18px;\n          padding: 16px;\n          font-style: italic;\n        }\n      "]);

    _templateObject_0919cb00598111eabae509a8b8475ead = function _templateObject_0919cb00598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_winEventsElement) {
    ...
    babelHelpers.createClass(HaxPreferencesDialog, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxPreferencesDialog), "styles", this)), [(0, _litElement.css)(_templateObject_0919cb00598111eabae509a8b8475ead())]);
      }
    }]);
    ...
    babelHelpers.createClass(HaxPreferencesDialog, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_0919cb00598111eabae509a8b8475ead(), this.opened, this.openedChanged, this.title, this.closeEvent, this.valueChanged, this.ghLink);
      }
    }, {
      key: "openedChanged",
      ...
      value: function firstUpdated(changedProperties) {
        this.shadowRoot.querySelector("#settingsform").fields = _objectSpread({}, this.schema);
        this.shadowRoot.querySelector("#settingsform").value = {}; // fire an event that this is a core piece of the system
