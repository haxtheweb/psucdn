define(["exports", "require", "../../lit-element/lit-element.js", "../simple-colors/simple-colors.js", "../utils/utils.js"], function (_exports, _require, _litElement, _simpleColors, _utils) {
  ...
  function _templateObject2_f3964920598011eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"bodycontainer\" class=\"ignore-activation\">\n        <slot id=\"body\"></slot>\n      </div>\n      <hax-text-context\n        id=\"textcontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-text-context>\n      <hax-ce-context\n        id=\"cecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-ce-context>\n      <hax-plate-context\n        id=\"platecontextmenu\"\n        class=\"hax-context-menu ignore-activation\"\n      ></hax-plate-context>\n    "]);

    _templateObject2_f3964920598011eabae509a8b8475ead = function _templateObject2_f3964920598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_f3964920598011eabae509a8b8475ead() {
    ...
    _templateObject_f3964920598011eabae509a8b8475ead = function _templateObject_f3964920598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_SimpleColors) {
    ...
    babelHelpers.createClass(HaxBody, null, [{
       ...
       */
      get: function get() {
        return [].concat(babelHelpers.toConsumableArray(babelHelpers.get(babelHelpers.getPrototypeOf(HaxBody), "styles", this)), [(0, _litElement.css)(_templateObject_f3964920598011eabae509a8b8475ead())]);
      }
      /**
       * HTMLElement
       */
    ...
    function HaxBody() {
      ...
      setTimeout(function () {
        ...
        _this.addEventListener("mouseover", _this._mouseOver.bind(babelHelpers.assertThisInitialized(_this)));
    ...
    babelHelpers.createClass(HaxBody, [{
      ...
      value: function dragEnterBody(e) {
        var children = this.childNodes; // walk the children and apply the draggable state needed
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_f3964920598011eabae509a8b8475ead());
      }
      /**
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "openDrawer") {
            _this3._openDrawerChanged(_this3[propName], oldValue);
          }
      ...
      key: "_openDrawerChanged",
      value: function _openDrawerChanged(newValue, oldValue) {
        var _this4 = this;

        if (!newValue) {
          this.hideContextMenus();
          setTimeout(function () {
            _this4.positionContextMenus();
          }, 100);
        } else {
          this.hideContextMenus();
        }
      ...
      value: function connectedCallback() {
          ...
          mutations.forEach(function (mutation) {
            ...
            if (mutation.addedNodes.length > 0) {
              mutation.addedNodes.forEach(function (node) {
                if (_this5._validElementTest(node)) {
                  ...
                  if (_this5.editMode && (node.getAttribute("contenteditable") == "true" || node.getAttribute("contenteditable") === true || node.getAttribute("contenteditable") == "contenteditable")) {
                    _this5.__applyNodeEditableState(node, !_this5.editMode);
                  }

                  _this5.__applyNodeEditableState(node, _this5.editMode);

                  _this5.dispatchEvent(new CustomEvent("hax-body-tag-added", {
                    bubbles: true,
                    cancelable: true,
                    composed: true,
                    detail: {
                  ...
                  if (!_this5.___moveLock && !mutFind) {
                    mutFind = true;
                    _this5.activeNode = node;
                    window.HaxStore.write("activeNode", node, _this5);
                  } else {
                    _this5.___moveLock = false;
                  }
                }
              });
            ...
            if (mutation.removedNodes.length > 0) {
              ...
              mutation.removedNodes.forEach(function (node) {
                if (_this5._validElementTest(node) && !node.classList.contains("hax-active")) {
                  _this5.dispatchEvent(new CustomEvent("hax-body-tag-removed", {
                    bubbles: true,
                    cancelable: true,
                    composed: true,
                    detail: {
        ...
        setTimeout(function () {
          window.addEventListener("keydown", _this5._onKeyDown.bind(_this5));
          window.addEventListener("keypress", _this5._onKeyPress.bind(_this5));
          document.body.addEventListener("hax-store-property-updated", _this5._haxStorePropertyUpdated.bind(_this5));
          window.addEventListener("scroll", _this5._keepContextVisible.bind(_this5));
        }, 0);
      }
      /**
       * HTMLElement
      ...
      value: function _keepContextVisible(e) {
        ...
        if (!this.openDrawer && this.editMode) {
          ...
          this.__contextVisibleLock = setTimeout(function () {
            ...
            if (_this6.shadowRoot.querySelector("#textcontextmenu").classList.contains("hax-context-visible")) {
              el = _this6.shadowRoot.querySelector("#textcontextmenu");
            } else if (_this6.shadowRoot.querySelector("#cecontextmenu").classList.contains("hax-context-visible")) {
              el = _this6.shadowRoot.querySelector("#cecontextmenu");
            } // if we see it, ensure we don't have the pin


            if (el) {
              var rect = _this6.activeContainerNode.getBoundingClientRect();

              _this6._positionContextMenu(_this6.shadowRoot.querySelector("#platecontextmenu"), _this6.activeContainerNode, rect.width - _this6.shadowRoot.querySelector("#platecontextmenu").getBoundingClientRect().width + 2, -28);

              if (_this6.elementInViewport(el)) {
                el.classList.remove("hax-context-pin-bottom", "hax-context-pin-top");
              } else {
                if (_this6.__OffBottom) {
            ...
            switch (e.key) {
              ...
              case "ArrowRight":
                ...
                this.__keyPress = setTimeout(function () {
                  var tmp = window.HaxStore.getSelection();
                  window.HaxStore._tmpSelection = tmp;
                  window.HaxStore.write("haxSelectedText", tmp.toString(), _this7);
                  var rng = window.HaxStore.getRange();

                  if (rng.commonAncestorContainer && _this7.activeNode !== rng.commonAncestorContainer && typeof rng.commonAncestorContainer.focus === "function") {
                    if (rng.commonAncestorContainer.tagName !== "HAX-BODY") {
                      if (window.HaxStore.instance.isTextElement(rng.commonAncestorContainer)) {
                        _this7.setAttribute("contenteditable", true);
                      } else {
                        _this7.removeAttribute("contenteditable");
                      }

                      rng.commonAncestorContainer.focus();

                      _this7.__focusLogic(rng.commonAncestorContainer);
                    }
                  } // need to check on the parent too if this was a text node
                  else if (rng.commonAncestorContainer && rng.commonAncestorContainer.parentNode && _this7.activeNode !== rng.commonAncestorContainer.parentNode && typeof rng.commonAncestorContainer.parentNode.focus === "function") {
                      if (rng.commonAncestorContainer.parentNode.tagName !== "HAX-BODY") {
                        ...
                        _this7.__focusLogic(rng.commonAncestorContainer.parentNode);
                      } else {
                        _this7.activeNode = rng.commonAncestorContainer;
                        _this7.activeContainerNode = _this7.activeNode;
                        window.HaxStore.write("activeNode", rng.commonAncestorContainer, _this7);
                        window.HaxStore.write("activeContainerNode", rng.commonAncestorContainer, _this7);
                        setTimeout(function () {
      ...
      value: function _onKeyPress(e) {
        ...
        clearTimeout(this.__keyPress);
        this.__keyPress = setTimeout(function () {
          if (!_this8.openDrawer && _this8.editMode && _this8.shadowRoot.querySelector("#textcontextmenu").classList.contains("hax-active-hover") && _this8.activeNode && window.HaxStore.instance.isTextElement(_this8.activeNode)) {
            _this8.__dropActiveHover();
          } else if (!_this8.openDrawer && _this8.editMode && _this8.activeNode && window.HaxStore.instance.isTextElement(_this8.activeNode)) {
            // If the user has paused for awhile, show the menu
            clearTimeout(_this8.__positionContextTimer);
            _this8.__positionContextTimer = setTimeout(function () {
      ...
      value: function replacePlaceholder(e) {
        ...
        if (e.detail === "text") {
          ...
          p.innerHTML = "<br/>";
          this.haxReplaceNode(this.activeNode, p, this.activeNode.parentNode); // allow swap out to happen

          setTimeout(function () {
            // set active to this p tag
            _this9.activeNode = p;
            window.HaxStore.write("activeNode", p, _this9);

            _this9.activeContainerNode.setAttribute("contenteditable", true); // focus on it


            p.focus();

            _this9.__focusLogic(p);
          }, 210);
        } else {
      ...
      value: function replaceElementWorkflow() {
        ...
        var element = window.HaxStore.nodeToHaxElement(activeNode, null);
        var type = "*";
      ...
      value: function haxInsert(tag, content) {
        ...
        if (window.HaxStore.instance.activePlaceHolder !== null && babelHelpers.typeof(window.HaxStore.instance.activePlaceHolder.style) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
          ...
          this.haxReplaceNode(window.HaxStore.instance.activePlaceHolder, newNode, window.HaxStore.instance.activePlaceHolder.parentNode);
      ...
      value: function haxDuplicateNode(node) {
        ...
        setTimeout(function () {
          ...
          if (parent === _this11) {
            window.HaxStore.write("activeContainerNode", nodeClone, _this11);
          }

          window.HaxStore.write("activeNode", nodeClone, _this11);
        }, 100);
        return true;
      }
      /**
      ...
      value: function hideContextMenus() {
        ...
        this._hideContextMenu(this.shadowRoot.querySelector("#platecontextmenu")); // force context menu state to closed
      ...
      value: function positionContextMenus() {
        ...
        if (node) {
          ...
          if (babelHelpers.typeof(props) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && !window.HaxStore.instance.isTextElement(node)) {
            ...
            this._positionContextMenu(this.shadowRoot.querySelector("#cecontextmenu"), container, -3, -30);
          } else {
            this._hideContextMenu(this.shadowRoot.querySelector("#cecontextmenu"));

            this._positionContextMenu(this.shadowRoot.querySelector("#textcontextmenu"), container, -3, -30);
          }

          if (container) {
            var rect = container.getBoundingClientRect();

            this._positionContextMenu(this.shadowRoot.querySelector("#platecontextmenu"), container, rect.width - this.shadowRoot.querySelector("#platecontextmenu").getBoundingClientRect().width + 2, -28);
      ...
      value: function haxMoveGridPlate(direction, node, container) {
        ...
        setTimeout(function () {
          _this12.positionContextMenus(node, container);
      ...
      value: function haxChangeTagName(node, tagName) {
        ...
        try {
          node.parentNode.replaceChild(replacement, node); // focus on the thing switched to
      ...
      value: function haxDeleteNode(node) {
        ...
        setTimeout(function () {
          ...
          _this14.activeContainerNode = null;
          window.HaxStore.write("activeNode", null, _this14);
          window.HaxStore.write("activeContainerNode", null, _this14);
          ...
          while (fragment.firstChild !== null) {
            if (babelHelpers.typeof(fragment.firstChild.tagName) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
              ...
              if (window.HaxStore.instance._isSandboxed && fragment.firstChild.tagName.toLowerCase() === "iframe") {
                ...
                _this15.appendChild(replacement);
              } else {
                _this15.appendChild(fragment.firstChild);
              }
            } else {
            ...
            if (window.HaxStore.instance.isTextElement(addData)) {
              setTimeout(function () {
                try {
                  ...
                  _this16.activeContainerNode = _this16.activeNode;
                  window.HaxStore.write("activeContainerNode", _this16.activeContainerNode, _this16);
                } catch (e) {
                  console.warn(e);
                }
              }, 0);
        ...
        if (!this.openDrawer && this.editMode) {
          ...
          try {
            ...
            if (e.dataTransfer && e.dataTransfer.items && e.dataTransfer.items.length > 0 && e.dataTransfer.items[0].kind === "file") {
              ...
              if (target && target.removeAttribute && target !== null && babelHelpers.typeof(local) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && target !== local && target !== local.parentNode && target.parentNode === this || local.parentNode === this) {
      ...
      value: function _activeNodeChanged(newValue, oldValue) {
        ...
        if (this.editMode && babelHelpers.typeof(newValue) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined)) && newValue !== null) {
          ...
          if (window.HaxStore.instance.isTextElement(newValue) || window.HaxStore.instance.isGridPlateElement(newValue)) {
            newValue.setAttribute("contenteditable", true);
            this.setAttribute("contenteditable", true); // position the operations / in context element
            ...
            this.__positionContextTimer = setTimeout(function () {
              if (newValue === _this19.activeNode) {
                _this19.positionContextMenus(newValue);
              }
            }, 10);
          } else {
            newValue.removeAttribute("contenteditable");
      ...
      value: function _hideContextMenu(menu) {
        ...
        menu.classList.remove("hax-context-visible", "hax-active-hover", "hax-context-pin-top", "hax-context-pin-bottom");
