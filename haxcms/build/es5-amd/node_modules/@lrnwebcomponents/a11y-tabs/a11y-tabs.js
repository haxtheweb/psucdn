define(["exports", "../../lit-element/lit-element.js", "../responsive-utility/responsive-utility.js", "../../@polymer/paper-button/paper-button.js", "../../@polymer/iron-icons/iron-icons.js", "../simple-tooltip/simple-tooltip.js", "./lib/a11y-tab.js"], function (_exports, _litElement, _responsiveUtility, _paperButton, _ironIcons, _simpleTooltip, _a11yTab) {
  ...
  function _templateObject3_00b9a0c0598111eabae509a8b8475ead() {
    ...
    _templateObject3_00b9a0c0598111eabae509a8b8475ead = function _templateObject3_00b9a0c0598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject2_00b9a0c0598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            <li>\n              <paper-button\n                id=\"", "-button\"\n                controls=\"", "\"\n                class=\"", "\"\n                @click=\"", "\"\n                ?disabled=\"", "\"\n                .flag=\"", "\"\n              >\n                <iron-icon\n                  class=\"flag-icon\"\n                  ?hidden=\"", "\"\n                  .icon=\"", "\"\n                >\n                </iron-icon>\n                <span class=\"label\">", "</span>\n                <span class=\"flag-type\" ?hidden=\"", "\">\n                  ", "\n                </span>\n                <iron-icon\n                  class=\"icon\"\n                  ?hidden=\"", "\"\n                  .icon=\"", "\"\n                >\n                </iron-icon>\n              </paper-button>\n              <simple-tooltip for=\"", "-button\"\n                >", "</simple-tooltip\n              >\n            </li>\n          "]);

    _templateObject2_00b9a0c0598111eabae509a8b8475ead = function _templateObject2_00b9a0c0598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_00b9a0c0598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <ul\n        id=\"tabs\"\n        .class=\"", "\"\n      >\n        ", "\n      </ul>\n      <div id=\"content\">\n        <slot></slot>\n      </div>\n    "]);

    _templateObject_00b9a0c0598111eabae509a8b8475ead = function _templateObject_00b9a0c0598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      value: function render() {
        ...
        return (0, _litElement.html)(_templateObject_00b9a0c0598111eabae509a8b8475ead(), this._showIcons(this.__hasIcons, this.iconBreakpoint, this.layoutBreakpoint, this.responsiveSize), this.tabs.map(function (tab, i) {
          return (0, _litElement.html)(_templateObject2_00b9a0c0598111eabae509a8b8475ead(), tab.id, tab.id, tab.id === _this2.activeTab ? "active" : "", function (e) {
            return _this2._handleTab(tab);
          }, tab.id === _this2.activeTab || tab.disabled, tab.flag, !tab.flagIcon, tab.flagIcon, tab.label, !tab.flag, tab.flag, !tab.icon, tab.icon, tab.id, tab.label);
        }));
      ...
      //styles function
      get: function get() {
        return [(0, _litElement.css)(_templateObject3_00b9a0c0598111eabae509a8b8475ead())];
      }
    }, {
      key: "haxProperties",
      get: function get() {
    ...
    babelHelpers.createClass(A11yTabs, [{
      ...
      value: function updateItems(e) {
        ...
        if (this.__tabs && this.__tabs.length > 0) this.__tabs.forEach(function (tab, index) {
          if (!tab.icon) _this5.__hasIcons = false;
          tab.order = index + 1;
          tab.total = _this5.__tabs.length;
        });
      ...
      get: function get() {
        ...
        return this.__tabs ? Object.keys(this.__tabs).map(function (index) {
          return _this6.__tabs[index];
        }) : [];
      }
    }]);
    return A11yTabs;
