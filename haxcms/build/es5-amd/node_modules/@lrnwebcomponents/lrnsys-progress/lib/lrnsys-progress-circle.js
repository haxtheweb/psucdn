define(["exports", "meta", "../../../@polymer/polymer/polymer-element.js", "../../circle-progress/circle-progress.js", "../../../@polymer/paper-button/paper-button.js", "../../simple-tooltip/simple-tooltip.js", "../../../@polymer/paper-styles/paper-styles.js", "../../../@polymer/paper-spinner/paper-spinner.js", "../../../@polymer/neon-animation/neon-animation.js", "../../../@polymer/iron-icons/iron-icons.js"], function (_exports, meta, _polymerElement, _circleProgress, _paperButton, _simpleTooltip, _paperStyles, _paperSpinner, _neonAnimation, _ironIcons) {
  ...
  function _templateObject_0b3a3a00598111eabae509a8b8475ead() {
    ...
    _templateObject_0b3a3a00598111eabae509a8b8475ead = function _templateObject_0b3a3a00598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(LrnsysProgressCircle, [{
      ...
      key: "template",
      get: function get() {
        return (0, _polymerElement.html)(_templateObject_0b3a3a00598111eabae509a8b8475ead());
      }
    }, {
      key: "tag",
      get: function get() {
      ...
      get: function get() {
        return {
          ...
          completeSound: {
            type: String,
            value: this.pathFromUrl(decodeURIComponent(meta.url)) + "assets/complete.mp3",
            reflectToAttribute: true
          },
          ...
          finishedSound: {
            type: String,
            value: this.pathFromUrl(decodeURIComponent(meta.url)) + "assets/finished.mp3",
            reflectToAttribute: true
          },
    ...
    function LrnsysProgressCircle() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(LrnsysProgressCircle).call(this));
      setTimeout(function () {
    ...
    babelHelpers.createClass(LrnsysProgressCircle, [{
      ...
      value: function _getActiveIcon(icon, iconComplete, status) {
        if (babelHelpers.typeof(icon) !== (typeof undefined === "undefined" ? "undefined" : babelHelpers.typeof(undefined))) {
