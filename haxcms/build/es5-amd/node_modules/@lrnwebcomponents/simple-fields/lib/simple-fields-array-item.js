define(["exports", "../../../lit-element/lit-element.js", "../../../@polymer/paper-icon-button/paper-icon-button.js", "../../../@polymer/paper-button/paper-button.js", "../../../@polymer/iron-icons/iron-icons.js", "../../simple-tooltip/simple-tooltip.js"], function (_exports, _litElement, _paperIconButton, _paperButton, _ironIcons, _simpleTooltip) {
  "use strict";
  ...
  function _templateObject2_0d1c1960598111eabae509a8b8475ead() {
    ...
    _templateObject2_0d1c1960598111eabae509a8b8475ead = function _templateObject2_0d1c1960598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_0d1c1960598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <div id=\"heading\">\n        <slot name=\"sort\"></slot>\n        <slot name=\"preview\"></slot>\n      </div>\n      <div id=\"content\">\n        <div id=\"content-inner\">\n          <div><slot></slot></div>\n          <paper-icon-button\n            id=\"remove\"\n            controls=\"", "\"\n            icon=\"delete\"\n            label=\"Remove this item\"\n            ?disabled=\"", "\"\n            @click=\"", "\"\n          >\n          </paper-icon-button>\n          <simple-tooltip for=\"remove\">Remove this item</simple-tooltip>\n        </div>\n      </div>\n    "]);

    _templateObject_0d1c1960598111eabae509a8b8475ead = function _templateObject_0d1c1960598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    babelHelpers.inherits(SimpleFieldsArrayItem, _LitElement);
    babelHelpers.createClass(SimpleFieldsArrayItem, [{
      key: "render",
      value: function render() {
        var _this2 = this;

        return (0, _litElement.html)(_templateObject_0d1c1960598111eabae509a8b8475ead(), this.id, this.disabled, function (e) {
      ...
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_0d1c1960598111eabae509a8b8475ead())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    function SimpleFieldsArrayItem() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SimpleFieldsArrayItem).call(this));
    ...
    babelHelpers.createClass(SimpleFieldsArrayItem, [{
      ...
      value: function connectedCallback() {
        ...
        setTimeout(function () {
           ...
           * @event add-item
           */
          _this3.dispatchEvent(new CustomEvent("added", {
            bubbles: true,
            cancelable: true,
            composed: true,
            detail: _this3
