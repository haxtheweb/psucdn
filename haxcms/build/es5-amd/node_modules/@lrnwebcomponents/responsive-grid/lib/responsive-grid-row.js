define(["exports", "../../../lit-element/lit-element.js", "../../responsive-utility/responsive-utility.js", "./responsive-grid-col.js", "./responsive-grid-clear.js"], function (_exports, _litElement, _responsiveUtility, _responsiveGridCol, _responsiveGridClear) {
  ...
  function _templateObject2_0cefb230598111eabae509a8b8475ead() {
    ...
    _templateObject2_0cefb230598111eabae509a8b8475ead = function _templateObject2_0cefb230598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_0cefb230598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <responsive-utility\n        xs=\"", "\"\n        sm=\"", "\"\n        md=\"", "\"\n        lg=\"", "\"\n        xl=\"", "\"\n        responsive-to-parent=\"", "\"\n      >\n      </responsive-utility>\n      <div id=\"row-inner\" screen=\"", "\" gutter=\"", "\">\n        <slot></slot>\n      </div>\n    "]);

    _templateObject_0cefb230598111eabae509a8b8475ead = function _templateObject_0cefb230598111eabae509a8b8475ead() {
      return data;
    };
  ...
  */
  var ResponsiveGridRow =
  /*#__PURE__*/
  function (_LitElement) {
    babelHelpers.inherits(ResponsiveGridRow, _LitElement);
    babelHelpers.createClass(ResponsiveGridRow, [{
      key: "render",
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_0cefb230598111eabae509a8b8475ead(), this.xs, this.sm, this.md, this.lg, this.xl, this.responsiveToParent, this.screen, this.gutter);
      }
      /**
       * convention
       */
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject2_0cefb230598111eabae509a8b8475ead())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    function ResponsiveGridRow() {
      ...
      babelHelpers.classCallCheck(this, ResponsiveGridRow);
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(ResponsiveGridRow).call(this));
      _this.xl = null;
      _this.lg = null;
      _this.md = null;
      _this.sm = null;
      _this.xs = null;
      _this.gutter = 0;
      _this.responsiveToParent = false;
      _this.screen = "xs";
    ...
    babelHelpers.createClass(ResponsiveGridRow, [{
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "screen") {
            // notify
            _this2.dispatchEvent(new CustomEvent("screen-changed", {
              detail: {
