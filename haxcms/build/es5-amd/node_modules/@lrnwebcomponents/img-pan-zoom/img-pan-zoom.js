define(["exports", "meta", "require", "../../lit-element/lit-element.js", "../es-global-bridge/es-global-bridge.js"], function (_exports, meta, _require, _litElement, _esGlobalBridge) {
  ...
  function _templateObject4_fadf5e10598011eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          position: relative;\n          height: 500px;\n        }\n        #viewer {\n          position: relative;\n          height: 100%;\n          width: 100%;\n        }\n\n        hexagon-loader {\n          opacity: 0;\n          display: block;\n          transition: opacity 700ms;\n          position: absolute;\n          margin: auto;\n          top: 0;\n          left: 0;\n          bottom: 0;\n          right: 0;\n          z-index: 1;\n          height: 70px;\n          width: 70px;\n        }\n        hexagon-loader[hidden] {\n          display: none;\n        }\n        hexagon-loader[loading] {\n          opacity: 1;\n        }\n      "]);

    _templateObject4_fadf5e10598011eabae509a8b8475ead = function _templateObject4_fadf5e10598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject3_fadf5e10598011eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n                  <hexagon-loader\n                    ?loading=", "\n                    item-count=\"4\"\n                    size=\"small\"\n                  ></hexagon-loader>\n                "]);

    _templateObject3_fadf5e10598011eabae509a8b8475ead = function _templateObject3_fadf5e10598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject2_fadf5e10598011eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            ", "\n            <img-loader\n              loaded=\"", "\"\n              @loaded-changed=\"", "\"\n              ?loading=\"", "\"\n              @loading-changed=\"", "\"\n              src=\"", "\"\n            ></img-loader>\n          "]);

    _templateObject2_fadf5e10598011eabae509a8b8475ead = function _templateObject2_fadf5e10598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_fadf5e10598011eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <!-- Only preload regular images -->\n      ", "\n\n      <!-- Openseadragon -->\n      <div id=\"viewer\"></div>\n    "]);

    _templateObject_fadf5e10598011eabae509a8b8475ead = function _templateObject_fadf5e10598011eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    ...
    babelHelpers.createClass(ImgPanZoom, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject_fadf5e10598011eabae509a8b8475ead(), !this.dzi ? (0, _litElement.html)(_templateObject2_fadf5e10598011eabae509a8b8475ead(), this.hideSpinner || this.loaded ? "" : (0, _litElement.html)(_templateObject3_fadf5e10598011eabae509a8b8475ead(), this.loading || !this.loaded), this.loaded, this.loadedChangedEvent, this.loading, this.loadingChangedEvent, this.src) : "");
      }
    }, {
      key: "pathFromUrl",
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject4_fadf5e10598011eabae509a8b8475ead())];
      }
    }, {
      key: "tag",
      get: function get() {
    ...
    babelHelpers.createClass(ImgPanZoom, [{
      ...
      value: function connectedCallback() {
        ...
        setTimeout(function () {
          ...
          if (_this3.dzi && _this3.__openseadragonLoaded) {
      ...
      value: function _initOpenSeadragon() {
        ...
        setTimeout(function () {
          ...
          _this4.viewer = new OpenSeadragon({
            element: _this4.shadowRoot.querySelector("#viewer"),
            visibilityRatio: _this4.visibilityRatio,
            constrainDuringPan: _this4.constrainDuringPan,
            showNavigationControl: _this4.showNavigationControl,
            showNavigator: _this4.showNavigator,
            zoomPerClick: _this4.zoomPerClick,
            zoomPerScroll: _this4.zoomPerScroll,
            animationTime: _this4.animationTime,
            navPrevNextWrap: _this4.navPrevNextWrap,
            showRotationControl: _this4.showRotationControl,
            minZoomImageRatio: _this4.minZoomImageRatio,
            maxZoomPixelRatio: _this4.maxZoomPixelRatio,
