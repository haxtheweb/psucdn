define(["exports", "../../../../lit-element/lit-element.js", "./haxcms-site-store.js", "../../../../mobx/lib/mobx.module.js", "../../../hax-body-behaviors/lib/HAXWiring.js", "../../../simple-colors/lib/simple-colors-polymer.js", "../../../../@polymer/iron-ajax/iron-ajax.js", "../../../jwt-login/jwt-login.js", "../../../h-a-x/h-a-x.js", "../../../simple-toast/simple-toast.js", "../../../simple-modal/simple-modal.js", "../../../../@polymer/paper-button/paper-button.js", "../../../hax-body/lib/hax-schema-form.js", "./haxcms-site-dashboard.js"], function (_exports, _litElement, _haxcmsSiteStore, _mobxModule, _HAXWiring, _simpleColorsPolymer, _ironAjax, _jwtLogin, _hAX, _simpleToast, _simpleModal, _paperButton, _haxSchemaForm, _haxcmsSiteDashboard) {
  ...
  function _templateObject_0f23a930598111eabae509a8b8475ead() {
    ...
    _templateObject_0f23a930598111eabae509a8b8475ead = function _templateObject_0f23a930598111eabae509a8b8475ead() {
      return data;
    };
   ...
   */
  var HAXCMSSiteEditor =
  /*#__PURE__*/
  function (_LitElement) {
    babelHelpers.inherits(HAXCMSSiteEditor, _LitElement);
    babelHelpers.createClass(HAXCMSSiteEditor, null, [{
      key: "tag",
    ...
    function HAXCMSSiteEditor() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(HAXCMSSiteEditor).call(this));
      _this.__disposer = [];
      _this.method = "POST";
    ...
    babelHelpers.createClass(HAXCMSSiteEditor, [{
      ...
      value: function firstUpdated(changedProperties) {
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          _this2.activeItem = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.activeItem);
      ...
      key: "_handleGetNodeFieldsResponse",
      value: function _handleGetNodeFieldsResponse(e) {
        ...
        var values = e.detail.response.values;
        var c = document.createElement("hax-schema-form"); // set a min width of 50 viewable

        c.style.minWidth = "50vw";

        for (var key in this._haxSchema.settings) {
          var schema = wiring.getHaxJSONSchema(key, this._haxSchema);
      ...
      value: function _saveNodeFieldsTap(e) {
        var values = this.__fieldsForm.value;
      ...
      value: function _handleCreateResponse(response) {
        var evt = new CustomEvent("simple-toast-show", {
          ...
          cancelable: true,
          detail: {
            text: "Created ".concat(this.__createNodeResponse.title, "!"),
            duration: 3000
          }
        });
        window.dispatchEvent(evt);
      ...
      value: function _handleDeleteResponse(response) {
        var evt = new CustomEvent("simple-toast-show", {
          ...
          cancelable: true,
          detail: {
            text: "Deleted ".concat(this.__deleteNodeResponse.title),
            duration: 3000
          }
        });
      ...
      value: function _handleNodeResponse(e) {
        ...
        if (typeof e.detail.location !== "undefined" && this.activeItem.location !== e.detail.location) {
          ...
          var active = this.manifest.items.find(function (i) {
