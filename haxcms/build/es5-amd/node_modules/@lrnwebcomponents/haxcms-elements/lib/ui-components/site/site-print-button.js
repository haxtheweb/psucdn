define(["exports", "require", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../@polymer/polymer/lib/elements/custom-style.js"], function (_exports, _require, _litElement, _haxcmsSiteStore, _customStyle) {
  ...
  function _templateObject2_1368f400598111eabae509a8b8475ead() {
    ...
    _templateObject2_1368f400598111eabae509a8b8475ead = function _templateObject2_1368f400598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_1368f400598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n        :host {\n          display: block;\n          text-rendering: optimizelegibility;\n          position: relative;\n        }\n      "]);

    _templateObject_1368f400598111eabae509a8b8475ead = function _templateObject_1368f400598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    babelHelpers.inherits(SitePrintButton, _LitElement);
    babelHelpers.createClass(SitePrintButton, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_1368f400598111eabae509a8b8475ead())];
      }
      /**
    ...
    babelHelpers.createClass(SitePrintButton, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_1368f400598111eabae509a8b8475ead(), this.icon, this.print, this.label, this.disabled, this.position, this.label);
      }
    }, {
      key: "updated",
                      ...
                      while (1) {
                        switch (_context.prev = _context.next) {
                          ...
                          case 2:
                            ...
                            _context.t2 = content;
                            _context.next = 7;
                            return fetch("pages/" + result[i].location + "/index.html").then(function (response) {
