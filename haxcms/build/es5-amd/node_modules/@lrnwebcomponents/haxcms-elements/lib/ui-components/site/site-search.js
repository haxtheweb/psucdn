define(["exports", "require", "../../../../../lit-element/lit-element.js"], function (_exports, _require, _litElement) {
  ...
  function _templateObject5_13709520598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n          <a class=\"result\" .href=\"", "\">\n            <div class=\"title\">\n              ", "<span class=\"link-text\" aria-hidden=\"true\"\n                >(", ")</span\n              >\n            </div>\n            <div class=\"date\">\n              <simple-datetime format=\"M jS\" .timestamp=\"", "\" unix\n                >", "</simple-datetime\n              >\n            </div>\n            <p>", "..</p>\n          </a>\n        "]);

    _templateObject5_13709520598111eabae509a8b8475ead = function _templateObject5_13709520598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject4_13709520598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral([""]);

    _templateObject4_13709520598111eabae509a8b8475ead = function _templateObject4_13709520598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject3_13709520598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n            Found ", " results.\n          "]);

    _templateObject3_13709520598111eabae509a8b8475ead = function _templateObject3_13709520598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject2_13709520598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <paper-input\n        id=\"search\"\n        always-float-label\n        label=\"Search\"\n        @value-changed=\"", "\"\n      >\n        <iron-icon icon=\"search\" slot=\"prefix\"></iron-icon>\n      </paper-input>\n      ", "\n      <lunr-search id=\"lunr\"></lunr-search>\n\n      ", "\n    "]);

    _templateObject2_13709520598111eabae509a8b8475ead = function _templateObject2_13709520598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_13709520598111eabae509a8b8475ead() {
    ...
    _templateObject_13709520598111eabae509a8b8475ead = function _templateObject_13709520598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    babelHelpers.inherits(SiteSearch, _LitElement);
    babelHelpers.createClass(SiteSearch, null, [{
       ...
       */
      get: function get() {
        return [(0, _litElement.css)(_templateObject_13709520598111eabae509a8b8475ead())];
      }
      /**
    ...
    babelHelpers.createClass(SiteSearch, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_13709520598111eabae509a8b8475ead(), this._searchValueChanged, this.search.length > 0 ? (0, _litElement.html)(_templateObject3_13709520598111eabae509a8b8475ead(), this.__results.length) : (0, _litElement.html)(_templateObject4_13709520598111eabae509a8b8475ead()), this.__results.map(function (item) {
          return (0, _litElement.html)(_templateObject5_13709520598111eabae509a8b8475ead(), item.location, item.title, item.location, item.created, item.created, item.description);
        }));
      }
    }, {
      key: "_searchValueChanged",
      value: function _searchValueChanged(e) {
        this.search = e.detail.value;
      }
    }, {
      key: "__resultsChanged",
      value: function __resultsChanged(e) {
        if (e.detail.value) {
          this.__results = babelHelpers.toConsumableArray(e.detail.value);
        } else {
          this.__results = [];
        }
      }
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          if (propName == "search") {
            _this2._searchChanged(_this2[propName], oldValue);

            _this2.shadowRoot.querySelector("#lunr").search = _this2[propName];
          }

          if (propName == "dataSource") {
            _this2.shadowRoot.querySelector("#lunr").dataSource = _this2[propName];
          }
        });
      }
      /**
