define(["exports", "../../../../../lit-element/lit-element.js", "../../core/haxcms-site-store.js", "../../../../../mobx/lib/mobx.module.js"], function (_exports, _litElement, _haxcmsSiteStore, _mobxModule) {
  ...
  function _templateObject2_1343b8c0598111eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n      <ol id=\"list\"></ol>\n    "]);

    _templateObject2_1343b8c0598111eabae509a8b8475ead = function _templateObject2_1343b8c0598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function _templateObject_1343b8c0598111eabae509a8b8475ead() {
    ...
    _templateObject_1343b8c0598111eabae509a8b8475ead = function _templateObject_1343b8c0598111eabae509a8b8475ead() {
      return data;
    };
  ...
  function (_LitElement) {
    babelHelpers.inherits(SiteDotIndicator, _LitElement);
    babelHelpers.createClass(SiteDotIndicator, null, [{
      key: "styles",
      get: function get() {
        return [(0, _litElement.css)(_templateObject_1343b8c0598111eabae509a8b8475ead())];
      }
    }]);
    ...
    function SiteDotIndicator() {
      ...
      _this = babelHelpers.possibleConstructorReturn(this, babelHelpers.getPrototypeOf(SiteDotIndicator).call(this));
      _this.__disposer = [];
      _this.scrollOnActive = false;
      return _this;
    }
    /**
    ...
    babelHelpers.createClass(SiteDotIndicator, [{
      ...
      value: function render() {
        return (0, _litElement.html)(_templateObject2_1343b8c0598111eabae509a8b8475ead());
      }
      /**
       * Props
       */
      ...
      value: function updated(changedProperties) {
        ...
        changedProperties.forEach(function (oldValue, propName) {
          ...
          if (propName == "routerManifest") {
            _this2._routerManifestChanged(_this2[propName], oldValue);
          }
        });
      }
    }, {
      ...
      value: function connectedCallback() {
        ...
        (0, _mobxModule.autorun)(function (reaction) {
          _this3.routerManifest = (0, _mobxModule.toJS)(_haxcmsSiteStore.store.routerManifest);
        ...
        if (this.scrollOnActive) {
          this.shadowRoot.querySelector("#list").addEventListener("click", function () {
            _this3.parentElement.querySelector("#" + _this3.activeId).scrollIntoView({
              behavior: "smooth",
              block: "end",
              inline: "nearest"
            });
      ...
      value: function disconnectedCallback() {
        ...
        if (this.scrollOnActive) {
          this.shadowRoot.querySelector("#list").removeEventListener("click", function () {
            _this4.parentElement.querySelector("#" + _this4.activeId).scrollIntoView({
              behavior: "smooth",
              block: "end",
              inline: "nearest"
            });
