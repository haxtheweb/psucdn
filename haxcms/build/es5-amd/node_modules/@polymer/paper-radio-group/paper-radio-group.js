define(["../polymer/polymer-legacy.js", "../iron-a11y-keys-behavior/iron-a11y-keys-behavior.js", "../paper-radio-button/paper-radio-button.js", "../iron-menu-behavior/iron-menubar-behavior.js", "../iron-selector/iron-selectable.js", "../polymer/lib/legacy/polymer-fn.js", "../polymer/lib/utils/html-tag.js"], function (_polymerLegacy, _ironA11yKeysBehavior, _paperRadioButton, _ironMenubarBehavior, _ironSelectable, _polymerFn, _htmlTag) {
  ...
  function _templateObject_f3220380598011eabae509a8b8475ead() {
    var data = babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        display: inline-block;\n      }\n\n      :host ::slotted(*) {\n        padding: var(--paper-radio-group-item-padding, 12px);\n      }\n    </style>\n\n    <slot></slot>\n"]);

    _templateObject_f3220380598011eabae509a8b8475ead = function _templateObject_f3220380598011eabae509a8b8475ead() {
      return data;
    };
  ...
  */
  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_f3220380598011eabae509a8b8475ead()),
    ...
    select: function select(value) {
      ...
      _ironSelectable.IronSelectableBehavior.select.apply(this, [value]);
    ...
    _onLeftKey: function _onLeftKey(event) {
      _ironMenubarBehavior.IronMenubarBehaviorImpl._onLeftKey.apply(this, arguments);

      this._activateFocusedItem();
    },
    _onRightKey: function _onRightKey(event) {
      _ironMenubarBehavior.IronMenubarBehaviorImpl._onRightKey.apply(this, arguments);
